...
all_features['FamilySize'] = all_features['SibSp'] + all_features['Parch'] + 1
# 提取我们关心的特征：存活率（Survived）、年龄（Age）、客舱等级（Pclass）、家庭总人数（FamilySize）
correlation_data = all_features[['Survived', 'Age', 'Pclass','SibSp','Fare','Parch','FamilySize','Sex','Title']]
